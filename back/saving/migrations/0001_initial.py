...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='FixedSavingProductsBaseInfo',
            fields=[
                ('base_product_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='기본 상품 ID')),
                ('fin_co_no', models.CharField(blank=True, max_length=20, null=True, verbose_name='금융회사 코드')),
                ('kor_co_nm', models.CharField(blank=True, max_length=255, null=True, verbose_name='금융회사 명')),
                ('fin_prdt_cd', models.CharField(blank=True, max_length=100, null=True, verbose_name='금융상품 코드')),
                ...
                ('join_deny', models.CharField(blank=True, max_length=5, null=True, verbose_name='가입제한')),
        ...
        migrations.CreateModel(
            name='FreeSavingProductsBaseInfo',
            fields=[
                ('base_product_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='기본 상품 ID')),
                ('fin_co_no', models.CharField(blank=True, max_length=20, null=True, verbose_name='금융회사 코드')),
                ('kor_co_nm', models.CharField(blank=True, max_length=255, null=True, verbose_name='금융회사 명')),
        ...
        migrations.CreateModel(
            name='FreeSavingProductsOption',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fin_co_no', models.CharField(blank=True, max_length=20, null=True, verbose_name='금융회사 코드')),
                ('fin_prdt_cd', models.CharField(blank=True, max_length=50, null=True, verbose_name='금융상품 코드')),
                ('intr_rate_type', models.CharField(blank=True, max_length=10, null=True, verbose_name='저축 금리 유형')),
                ('intr_rate_type_nm', models.CharField(blank=True, max_length=30, null=True, verbose_name='저축 금리 유형명')),
                ...
                ('base_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='saving.freesavingproductsbaseinfo', verbose_name='기본 상품')),
            ],
            options={
                'verbose_name': '자유적금 상품 기본 정보',
        ...
        migrations.CreateModel(
            name='FixedSavingProductsOption',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fin_co_no', models.CharField(blank=True, max_length=20, null=True, verbose_name='금융회사 코드')),
                ('fin_prdt_cd', models.CharField(blank=True, max_length=50, null=True, verbose_name='금융상품 코드')),
                ...
                ('intr_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='저축 금리')),
                ('intr_rate2', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='최고 우대금리')),
                ('base_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='saving.fixedsavingproductsbaseinfo', verbose_name='기본 상품')),
            ],
            options={
