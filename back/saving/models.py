...
class FixedSavingProductsBaseInfo(models.Model):
    ...
    fin_co_no = models.CharField(max_length=20, null=True, blank=True, verbose_name="금융회사 코드")
    kor_co_nm = models.CharField(max_length=255, null=True, blank=True, verbose_name="금융회사 명")
    fin_prdt_cd = models.CharField(max_length=100, null=True, blank=True, verbose_name="금융상품 코드")
    ...
    join_deny = models.CharField(max_length=5, null=True, blank=True, verbose_name="가입제한")
...
class FixedSavingProductsOption(models.Model):
    ...
    fin_co_no = models.CharField(max_length=20, null=True, blank=True, verbose_name="금융회사 코드")
    fin_prdt_cd = models.CharField(max_length=50, null=True, blank=True, verbose_name="금융상품 코드")
    intr_rate_type = models.CharField(max_length=10, null=True, blank=True, verbose_name="저축 금리 유형")
    intr_rate_type_nm = models.CharField(max_length=30, null=True, blank=True, verbose_name="저축 금리 유형명")
