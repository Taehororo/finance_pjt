...
class DepositProductsBaseInfo(models.Model):
    ...
    fin_co_no = models.CharField(max_length=8, verbose_name="금융회사 코드")
    kor_co_nm = models.CharField(max_length=255, verbose_name="금융회사 명")
    fin_prdt_cd = models.CharField(max_length=15, verbose_name="금융상품 코드")
...
class DepositProductsOption(models.Model):
    ...
    intr_rate_type = models.CharField(max_length=1, verbose_name="저축 금리 유형")
    intr_rate_type_nm = models.CharField(max_length=10, verbose_name="저축 금리 유형명")
